/**
 * @name NitroPerks
 * @website https://github.com/MrPumpkins/BlueDDs-Nitro
...
module.exports = (() => {
    const config = {
        "info": {
            "name": "BlueDD's Nitro Plugin",
            "authors": [
                {
                    "name": "BlueDD",
                    "discord_id": "929436993564327996",
                    "github_username": "MrPumpkins"
                }
            ],
/**This is an Unofficial Fork Of JpabloNB i do not own anything!
 * Do not use this without permission... just like i did! i have done exactly no effort in this. knowing that i dont have a github page.
 */
            "version": "1.0",
            "description": "Trick Discord Into Thinking You Got The Nitro! Having All Of It Perks! But.. No 100MB Uploads :(",
		...
		"changelog": [
			{
				"title": "Fixed Errors",
				"type": "fixed",
                "items": ["Fixed Some Errors That made you crash alot."]
			},
			{
				"title": "Also Fixed",
				"type": "fixed",
                "items": ["Client Sided Avatar Not Loading"]
			},
		],
